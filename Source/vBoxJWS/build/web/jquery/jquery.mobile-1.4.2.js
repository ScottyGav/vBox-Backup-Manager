		...
		enhanceWithin: function() {
			...
			$.each( $.mobile.widgets, function( name, constructor ) {
				...
				if ( constructor.initSelector ) {
					...
					if ( elements.length > 0 ) {
						widgetElements[ constructor.prototype.widgetIDeviceName ] = elements;
					}
				}
			});
...
$.widget = function( name, base, prototype ) {
	...
	if ( existingConstructor ) {
		$.each( existingConstructor._childConstructors, function( i, child ) {
			...
			$.widget( childPrototype.namespace + "." + childPrototype.widgetIDeviceName, constructor, child._proto );
		});
...
$.Widget.prototype = {
	...
	_createWidget: function( options, element ) {
		...
		this.uuid = uuid++;
		this.eventNamespace = "." + this.widgetIDeviceName + this.uuid;
...
$.widget = (function( orig ) {
	return function() {
		var constructor = orig.apply( this, arguments ),
			name = constructor.prototype.widgetIDeviceName;
	...
	$.widget( "mobile.pagecontainer", {
		...
		_triggerWithDeprecated: function( name, data, page ) {
			var deprecatedEvent = $.Event( "page" + name ),
				newEvent = $.Event( this.widgetIDeviceName + name );
...
$.widget( "mobile.controlgroup", $.extend( {
	...
	_create: function() {
		...
		$.each( this._childWidgets, $.proxy( function( number, widgetIDeviceName ) {
			if ( $.mobile[ widgetIDeviceName ] ) {
				this.element.find( $.mobile[ widgetIDeviceName ].initSelector ).not( $.mobile.page.prototype.keepNativeSelector() )[ widgetIDeviceName ]();
			}
		}, this ));
...
$.widget( "mobile.table", $.mobile.table, {
	...
	_id: function() {
		return ( this.element.attr( "id" ) || ( this.widgetIDeviceName + this.uuid ) );
	},
...
$.widget( "mobile.filterable", $.mobile.filterable, {
	...
	_create: function() {
		...
		for ( idx = recognizedWidgets.length - 1 ; idx > -1 ; idx-- ) {
			widgetIDeviceName = recognizedWidgets[ idx ];
			if ( $.mobile[ widgetIDeviceName ] ) {
				if ( this._setWidget( elem.data( "mobile-" + widgetIDeviceName ) ) ) {
					break;
				} else {
					createHandlers[ widgetIDeviceName + "create" ] = "_handleCreate";
				}
			}
		}
	...
	_setWidget: function( widget ) {
		...
		if ( !!this._widget ) {
			...
			if ( this._widget.widgetIDeviceName === "listview" ) {
